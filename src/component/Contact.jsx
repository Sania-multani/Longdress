     ...
     <section className="contact-section mt-0">
      <div className="contact-container">
        ...
        <div className="contact-image">
          <img src="assets/images/dres31.jpg" alt="Shoes" />
        </div>
      </div>
    </section>
    </div>
