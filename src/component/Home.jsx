...
const categories = [
  { label: 'Anarkali', image: '/assets/images/dres23.jpg' },
  { label: 'Jaipuru suits', image: '/assets/images/dres24.jpg' },
  { label: 'Jaipuru suits', image: '/assets/images/dres25.jpg' },
  { label: 'Partywear', image: '/assets/images/dres27.jpg' },
  { label: 'Jaipuru suits', image: '/assets/images/dres28.jpg' },
  // { label: 'Formal Wear', image: '/assets/images/dres22.png' },
];
...
const testimonials = [
  ...
  },
  {
   ...
   const images = [
    'assets/images/dres29.jpg',
    'assets/images/dres30.jpg',
    'assets/images/dres31.jpg',
     'assets/images/dres32.jpg',
    'assets/images/dres33.jpg',
    'assets/images/dres29.jpg',
     'assets/images/dres30.jpg',
    'assets/images/dres31.jpg',
    'assets/images/dres32.jpg',
     'assets/images/dres33.jpg',
    'assets/images/dres34.jpg',
    'assets/images/dres29.jpg',
  ];
...
function Home() {
  ...
  return (
    <>
     ...
     <div>
      <img src="assets/images/dres14.jpg"  className="cstm-img-sec"></img>
     </div>
    ...
    <div className="container-fluid">
      <img src="assets/images/dres9.jpg" className="w-100"></img>
    </div>
        ...
        <div className="col-lg-6">
          <div className="row">
                <div className="col-lg-6">
                  <div className="cstm-a ">
                       <img src="assets/images/dres34.jpg" className="img-fluid"></img>
                ...
                <div className="col-lg-6">
                        ...
                        <div className="cstm-a ">
                       <img src="assets/images/dres35.jpg" className="img-fluid"></img>
                       <div className="cstm-b">
                         <button type="button" className="cstm-c">SHOP NOW</button>
                       </div>
                       </div>
            ...
            <div className="row mt-4">
                <div className="col-lg-6">
                       ...
                       <div className="cstm-a ">
                       <img src="assets/images/dres37.jpg" className="img-fluid"></img>
                       <div className="cstm-b">
                         <button type="button" className="cstm-c">SHOP NOW</button>
                       </div>
                       </div>
                ...
                <div className="col-lg-6">
                        ...
                        <div className="cstm-a ">
                       <img src="assets/images/dres38.jpg" className="img-fluid"></img>
                       <div className="cstm-b">
                         <button type="button" className="cstm-c">SHOP NOW</button>
                       </div>
                       </div>
         ...
         <div className="col-lg-6">
          <div className="cstm-d">
             <img src="assets/images/dres39.jpg"  className="img-fluid"></img>
      ...
      <div className="row">
        <div className="col-lg-3">
          <div  className="cstm-big-div-prdt">
            <img src="assets/images/dres40.jpg" className="img-fluid   cstm-prodt-sec"></img>
         ...
         <div className="col-lg-3">
             <div  className="cstm-big-div-prdt">
            <img src="assets/images/dres41.jpg" className="img-fluid   cstm-prodt-sec"></img>
            <div  className="cstm-add-cart-btn">
              <p className="mt-3 cstm-text-prdt">Blue Shirt</p>
              <p className="text-white cstm-rs-sec ">Rs.230</p>
         ...
         <div className="col-lg-3">
             <div  className="cstm-big-div-prdt">
            <img src="assets/images/dres42.jpg" className="img-fluid   cstm-prodt-sec"></img>
            {/* <div  className="cstm-add-cart-btn">
         ...
         <div className="col-lg-3">
            {/* <img src="assets/images/shirt52.jpg" className="img-fluid"></img> */}
             <div  className="cstm-big-div-prdt">
            <img src="assets/images/dres43.jpg" className="img-fluid   cstm-prodt-sec"></img>
            {/* <div  className="cstm-add-cart-btn">
